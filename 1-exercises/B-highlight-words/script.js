...
// If 'none' is selected in the dropdown, then no highlighting should be applied to the words, or highlighting
// should be removed if the clicked word is already highlighted.
...
// - We can then update the `background-color` property of the `<span>` with the value of the select - remember that the value
//   "none" is a special case and we need to be handled differently.
