...
function highlightWords(paragraph, colours) {
  ...
  document.querySelector("#content").appendChild(pText);
  ...
  paragraph.split(" ").forEach((word) => {
    ...
    span.addEventListener("click", () => {
      let pickColor = selectColor.value;
      if (pickColor === "none") {
        span.style.backgroundColor = "trasparent";
      } else {
        span.style.backgroundColor = pickColor;
      }
    });
  });
}
...
// newArray.array.forEach(word => {
//   const wordSpan =document.createElement("span");
//   wordSpan.innerText = word + " ";
//   pText.appendChild(wordSpan);
