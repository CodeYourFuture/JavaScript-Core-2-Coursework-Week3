...
- The event listener should also remove the c style conditionally by checking if the style is already applied. Hint: try adding a CSS classe to styles.css for this.
