...
function addNewTodo(event) {
  ...
  let todoEl = document.querySelectorAll("#todo-list li"); // Selects all previous the todo elements
  todoEl.forEach((todo) => list.removeChild(todo)); // Removes all the previous todo elements
  ...
  populateTodoList(todos); // This function rebuilds the todo list
...
function deleteAllCompletedTodos(event) {
  ...
  todoEL.forEach((todoLi) => {
    ...
    if (todoLi.className.includes("completed")) {
